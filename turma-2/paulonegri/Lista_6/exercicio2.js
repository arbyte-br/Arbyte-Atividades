...
let itensA = respostasJogadorA[i]
    for(let j = 0; j <tamanhoDaLista; j++){
        ...
        if(itensA !== itensB){
            let numerosApenasDaListaA = !numerosRepetidos.includes(itensB)
            if(numerosApenasDaListaA){
                let numerosRepetidosDaListaA = !numerosRepetidos.includes(itensA)
                if(numerosRepetidosDaListaA){
